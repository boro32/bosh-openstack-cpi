...
func (n OpenStackComputeNetworkService) Find(id string) (Network, bool, error) {
	n.logger.Debug(openstackComputeNetworkServiceLogTag, "Finding OpenStack Network '%s'", id)
